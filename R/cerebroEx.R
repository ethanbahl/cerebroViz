...
#'
#' This matrix exemplifies the basic format cerebroViz requires of its input. The data is raw expression levels for the POGZ gene taken from the Brainspan developmental transcriptome.
#'
